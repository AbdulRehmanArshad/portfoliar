            ...
            <div class="container max-w-screen-xl mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6">
                    <div class="bg-gray-50 px-8 py-10 rounded-md">
                        <h4 class="font-medium text-gray-700 text-lg mb-4">2017 – 2020</h4>
                        <p class="font-normal text-gray-500 text-md mb-4">BACHELOR IN SOFTWARE ENGINNERING FROM GIFT UNIVERSITY</p>
                        <div class="relative">
