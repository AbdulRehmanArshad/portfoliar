...
<div class="container max-w-screen-xl mx-auto px-4">
    ...
    <nav class="flex items-center justify-between mb-40">
        <img class="md:animate-spin object-scale-down h-20 ..." src={logo} alt="Logo"/>

        <button class="px-7 py-3 md:px-9 md:py-4 bg-white font-medium md:font-semibold text-gray-700 text-md rounded-md hover:bg-gray-700 hover:text-white transition ease-linear duration-500" onClick={DownloadFile}>Get my CV</button>
    </nav>

    <div class="text-center">
        <div class="flex justify-center mb-16">
            <img  class ="object-scale-down h-60 w-500 ... rounded-lg"  src={profile} alt="Image"/>
        </div>

        <h6 class="font-medium text-gray-600 text-lg md:text-2xl uppercase mb-8">AbdulRehman Arshad</h6>

        <h1 class="font-normal text-gray-900 text-4xl md:text-7xl leading-none mb-8">Junior Frontend Developer</h1>
