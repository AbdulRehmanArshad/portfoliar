...
<div class="container max-w-screen-xl mx-auto px-4">
    ...
    <div class="text-center">
        <h1 class="font-medium text-gray-700 text-4xl md:text-5xl mb-5">Expertise</h1>

        <p class="font-normal text-gray-400 text-md md:text-lg mb-20">I got the experience.
Here is my toolbelt for success.</p>

        <div class="flex items-center justify-center space-x-8">
            <a href="#" class="w-20 h-20 flex items-center justify-center rounded-full hover:bg-gray-200 transition ease-in-out duration-500">
