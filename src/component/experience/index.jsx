...
<div class="container max-w-screen-xl mx-auto px-4">
    ...
    <div class="flex flex-col lg:flex-row justify-between">
        <div class="space-y-8 md:space-y-16 mb-16 md:mb-0">
            ...
            <p class="font-semibold text-gray-600 text-base">Nextep Technology <span class="font-normal text-gray-300">/ Islamabad</span></p>

            <p class="font-semibold text-gray-600 text-base">Phaedra Solution <span class="font-normal text-gray-300">/ Lahore</span></p>
        ...
        <div class="space-y-8 md:space-y-16">
            ...
            <p class="font-normal text-gray-400 text-base">2022</p>
